...
# The class should not use system input at all; it will only handle the input that comes to it 
# via this method and its string argument.
# The first problem that comes to mind: how to write that method in a way 
# that it represents all that coffee machine can do? If the user inputs a single number, 
# how can the method determine what that number is: 
...
# Make it so that you can communicate with the coffee machine through a single method. Good luck!
#
# Examples
